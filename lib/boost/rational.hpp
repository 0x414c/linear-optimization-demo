...
#include <lib/boost/call_traits.hpp> // for boost::call_traits
#include <lib/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <lib/boost/assert.hpp>      // for BOOST_ASSERT
#include <lib/boost/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
